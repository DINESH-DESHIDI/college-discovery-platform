      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 max-w-sm text-sm text-muted-foreground">
            Discover, compare, and choose from 10,000+ colleges across the country. Make informed decisions with verified data.
          </p>
          <div className="mt-5 flex gap-2">
            {[Twitter, Linkedin, Instagram, Github].map((Icon, i) => (
              <a key={i} href="#" className="flex h-9 w-9 items-center justify-center rounded-lg border border-border text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
            <li><Link to="/colleges" className="hover:text-foreground">All Colleges</Link></li>
